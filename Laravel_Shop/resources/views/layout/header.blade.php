<div id="header">
    ...
    <div class="header-body">
        <div class="container beta-relative">
            <div class="pull-left">
                <a href="index.html" id="logo"><img src="source/image/product/logo-cake.png" width="200px" alt=""></a>
            </div>
                    ...
                    <div class="cart">
                        ...
                        <div class="beta-dropdown cart-body" style="z-index:1000">
                            ...
                            <div class="cart-caption">
                                ...
                                <div class="center">
                                    <div class="space10">&nbsp;</div>
                                    <a href="shopping-cart" class="beta-btn primary text-center">Giỏ hàng<i class="fa fa-chevron-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div> 
